...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-4'>
      <Link to='/'>
        <img src={assets.logo} alt='' className='w-32 sm:w-36 lg:w-50' />
      </Link>
      ...
      <div>
        ...
        user ?
         <div className='flex items-center gap-2 sm:gap-3'>
          <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-cyan-200 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
         ...
         <div className='flex items-center gap-2 sm:gap-5'>
          <p onClick={()=>navigate('/buy')} className='cursor-pointer'>Get Premium</p>
