    ...
    onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] justify-center items-center'>
      ...
      <div>
        <div className='relative'>
          ...
          <span className={`absolute bottom-0 left-0 h-1 bg-blue-300 ${loading ?'  w-full transition-all duration-[10s]':'w-0'}`}/>
      ...
      <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
        ...
        type="text" placeholder='Describe your vision, and let us bring it to life.' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color'/>
